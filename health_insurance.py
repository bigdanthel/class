...
class HealthInsurance:
    ...
    def sup_health_insurance(self, age, chronic_disease, income):
      ...
      if age >= 60 and chronic_disease == True and income < 6000:
        print("You are not eligible for supplemental health insurance.")
      elif age < 60 and chronic_disease == False or income >= 6000:
        print("You can get supplemental health insurance.")
